...
def split_training_test(wavelet_path, out_put_path, training_scale):
    training_set_path = out_put_path + '/training_set.txt'
    test_set_path = out_put_path+'/test_set.txt'
...
if __name__ == '__main__':
    split_training_test('C:/Users/song/data/wavelets', 'C:/Users/song/data/wavelets', 0.8)
