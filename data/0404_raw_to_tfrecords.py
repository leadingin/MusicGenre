...
if __name__ == "__main__":
    ...
    convert_wavelets_to_tfrecords(raw_and_spilit_file_path, training_set_path, "merge/raw_data_training.tfrecords")
    convert_wavelets_to_tfrecords(raw_and_spilit_file_path, test_set_path, "merge/raw_data_test.tfrecords")
